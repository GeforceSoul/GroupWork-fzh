...
<body>
	...
	<ul>
		...
		<li><a class="topbutton" id="link" href="news">新闻</a></li>
		<li><a class="topbutton" href="announcement">公告</a></li>
		<li><a class="topbutton"  href="manager.jsp">管理员入口</a></li>
	</ul>
	<div class="left">
		<ul>
			<li><a id="link" href="news">新闻相关</a></li>
			<li><a class="little" id="littlelink" href="news">新闻列表</a></li>
			<li><a class="little" href="news">新闻正文</a></li>
		</ul>
	</div>
	...
	<div class="article">
		...
		<table>
			<tr>
				...
				<td><a href="news_show2?NewsShowID=${s.newsID}">查看</a></td>
