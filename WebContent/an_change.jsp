...
<body>
	...
	<div class="left">
		<ul>
			...
			<li><a class="little" id="littlelink" href="an_see">管理公告</a></li>
	...
	<div class="article">
		<form action="AnchangeServlet" method="post">
			<input id="changeID" name="AnID" type="hidden">
			<script type="text/javascript">
        document.getElementById('changeID').value=window.location.href.split("?")[1].split("=")[1];
			...
			<table>
				<tr>
					<td>请输入标题：</td>
					<td><input type="text" name="AnTitle" size="80" ></td>
				</tr>
				<tr>
					<td>请输入正文：</td>
					<td><input type="text" name="AnText" size="80" ></td>
				</tr>
				<tr>
					<td>请输入日期：</td>
					<td><input type="text" name="AnDateTime"></td>
				</tr>
				<tr>
